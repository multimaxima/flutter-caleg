...
import 'package:caleg/model/scanner_provider.dart';
import 'package:caleg/ktpscanner/constant.dart';
import 'package:caleg/ktpscanner/nik_item.dart';
import 'package:caleg/ktpscanner/text_painter.dart';
import 'package:provider/provider.dart';

class ScanerKtp extends StatefulWidget {
  final int id;
  const ScanerKtp(this.id, {Key? key}) : super(key: key);
